...
Window_NameInput.LATIN2 =
        ...
        [ '什','切','升','收','壬',  '少','心','手','日','氏',
          ...
          '巨','冬','他','代','只',  '仗','另','句','召','尼',
          '正','田','旦','奴','凸',  '立','叮','仝','伏','台',
          '奶','凹','五','外','央',  '右','未','第3页','下一页','决定' ];
		  Window_NameInput.LATIN4 =
[
'永','以','戊','玉','瓦','由','幼','仕','巧','丘',
'仙','兄','司','且','史','左','世','出','市','玄',
'仔','冉','穴','示','生','申','充','主','仞','仟',
...
'疋','矛','乎','付','兄','卉','戊','民','冰','玄',
'白','卯','伉','光','匡','共','各','考','交','件',
'价','企','伍','伎','仰','吉','圭','第4页','下一页','决定' ];
Window_NameInput.LATIN5 =
[
'曲','机','艮','六','仲','吉','州','朱','兆','决',
'匠','地','旨','朵','吏','列','年','劣','同','打',
'汀','至','臼','灯','竹','老','舟','伎','吊','吏',
...
'全','再','冲','刑','向','在','夙','如','宅','守',
'字','存','寺','式','戌','收','早','旭','旬','曲',
'次','此','求','系','肉','臣','自','第5页','下一页','决定' ];
Window_NameInput.LATIN6 =
[
'舌','血','行','圳','西','休','交','件','企','匠',
'吉','尖','而','至','色','伏','后','名','回','好',
'妃','帆','灰','牟','百','份','米','伐','亥','卉',
...
'岐','我','扣','杞','江','究','见','角','言','住',
'占','低','佃','况','里','冷','伶','利','助','努',
'君','吝','昌','壮','妓','妞','局','第6页','下一页','决定' ];
Window_NameInput.LATIN7 =
[
'弄','廷','弟','彤','志','托','杖','杜','呆','李',
'江','男','究','良','见','角','具','皂','里','舟',
'佟','你','体','足','甸','町','豆','吞','玎','位',
...
'吹','呈','坐','孝','宋','岐','希','岑','床','序',
'巡','形','忍','成','杏','材','杉','束','村','杞',
'步','汝','汐','池','私','秀','赤','第7页','下一页','决定' ];
Window_NameInput.LATIN8 =
[
'足','身','车','辰','系','占','伺','住','余','助',
'劭','劬','邵','吸','坐','壮','妆','局','床','志',
'汕','江','灶','见','即','却','克','早','何','布',
...
'儿','供','侃','刻','卦','固','坤','姑','官','冈',
'庚','快','抗','昆','果','空','亟','其','具','券',
'卷','奇','委','季','宜','居','届','第8页','下一页','决定' ];
Window_NameInput.LATIN9 =
[
'岢','岸','杰','佳','京','侄','佳','来','例','制',
'到','兔','两','典','卷','周','呢','坦','奈','妮',
'宙','定','居','屉','帖','底','店','征','忝','忠',
...
'岭','帖','帙','底','抒','林','杼','沓','炉','竺',
'长','依','侑','味','夜','委','宜','宛','岳','岸',
'岩','往','亚','武','於','易','昂','第9页','下一页','决定' ];
Window_NameInput.LATIN10 =
[
'旺','沅','沃','汪','物','艾','卧','佯','儿','咏',
'抑','昀','炎','杳','事','享','侍','使','侈','然',
'刹','刺','协','卒','洽','沁','取','受','步','垂',
...
'争','其','刷','券','制','效','卷','姐','姒','姗',
'季','炙','宗','届','岫','征','承','昔','析','枕',
'状','八','并','佩','函','和','命','第10页','下一页','决定' ];
Window_NameInput.LATIN11 =
[
'坡','坪','奉','孟','帛','水','府','佛','彼','忽',
'或','戽','房','扮','枇','扶','放','昏','朋','服',
'明','杭','杯','枚','板','沛','沐','汾','版','牧',
...
'冒','段','劲','南','姬','姜','姣','宦','帝','度',
'痔','建','峙','待','律','怠','急','招','拒','拓',
'拙','拉','昭','架','柱','柳','注','第11页','下一页','决定' ];
Window_NameInput.LATIN12 =
[
'治','炭','界','皆','突','纪','纣','耐','肚','致',
'计','订','军','酊','俐','胃','百','厘','咨','姝',
'姿','柁','沱','炭','妆','纣','重','珏','盅','眈',
...
'衍','要','页','音','昱','柚','胤','易','信','侠',
'系','俗','促','俏','前','则','奏','型','姹','妊',
'姝','姿','室','宣','巷','咱','哉','第12页','下一页','决定' ];
Window_NameInput.LATIN13 =
[
'思','性','施','昨','是','春','星','查','柴','栅',
'柔','染','泉','帅','甚','相','省','砂','祈','秋',
'穿','肖','重','首','酉','食','香','侵','俟','峙',
...
'玫','盆','眉','红','美','虹','秒','表','负','面',
'风','飞','眄','胃','勃','厚','咸','叛','孩','奂',
'屏','枰','某','河','泛','赴','库','第13页','下一页','决定' ];
Window_NameInput.LATIN14 =
[
'恭','拱','格','桂','根','耕','耿','股','肯','贡',
'高','个','刚','哥','宫','径','挂','皋','径','徒',
'倜','恬','拯','指','拿','料','旅','晋','朕','桌',
...
'只','挑','借','倒','值','俱','倪','倘','伦','兼',
'唐','哲','娘','旃','娟','娜','展','峻','准','凌',
'洲','套','爹','特','留','俩','倜','第14页','下一页','决定' ];
Window_NameInput.LATIN15 =
[
'庭','恫','耻','烙','料','栗','株','津','玳','畜',
'砧','恩','按','案','鸟','洋','秧','翁','纹','耘',
'育','芽','芸','蚊','袁','烟','倚','原','员','埃',
...
'洽','珊','祠','神','祖','秦','秤','索','素','纱',
'纾','纯','虔','讫','训','财','起','轩','芩','闪',
'迅','倩','幸','修','仓','城','夏','第15页','下一页','决定' ];
Window_NameInput.LATIN16 =
[
'孙','宰','容','射','峡','厝','叟','奚','畜','春',
'乘','借','准','淞','宵','指','拭','牲','洵','洳',
'狩','兹','珊','炸','租','站','宸','挈','旁','晃',
...
'涵','畔','埔','害','恢','恍','恒','柏','派','洹',
'玻','泌','珉','祜','呗','国','寇','昆','康','苦',
'袍','规','贯','够','勘','崞','岗','第16页','下一页','决定' ];
Window_NameInput.LATIN17 =
[
'梗','珙','偕','假','健','停','侦','剪','动','翎',
'念','基','坚','堂','堆','婧','寄','专','张','得',
'教','救','朗','条','梁','梯','械','梨','浙','浪',
...
'崃','带','帐','徕','悌','画','梁','梃','桶','町',
'娄','伟','偶','务','唯','问','婉','寅','尉','帷',
'庸','悟','悠','悦','敖','晚','梧','第17页','下一页','决定' ];
Window_NameInput.LATIN18 =
[
'浴','眼','研','移','胃','苑','英','迎','野','鱼',
'欲','浣','翌','圉','乾','做','区','卿','参','售',
'启','商','唱','娶','妇','宿','崇','崎','崔','常',
...
'责','赦','雀','雪','顷','彩','常','孰','侦','匙',
'圊','执','将','专','就','峥','崧','巢','庶','彩',
'悉','施','曹','浙','笙','钏','阡','第18页','下一页','决定' ];
Window_NameInput.LATIN19 =
[
'凰','毫','培','婚','婆','妇','密','彬','彪','患',
'斌','曼','海','浩','烽','班','瓶','毕','盒','符',
'邦','胡','背','胞','胖','舶','范','茅','苗','袍',
...
'贵','辜','开','凯','昆','诒','询','几','蛟','植',
'堵','堤','奠','岚','帧','掌','掘','捷','掏','掎',
'推','探','接','敦','景','智','晶','第19页 ','下一页','决定' ];
Window_NameInput.LATIN20 =
[
'替','朝','椒','棠','栈','殖','淘','添','淡','净',
'焦','街','诊','理','荔','眨','贴','屠','贷','轸',
'迢','迪','迦','量','钧','钮','间','集','杰','劳',
...
'寓','云','雯','媛','喻','贻','婺','焱','琬','琰',
'畲','劳','博','堡','报','富','寒','嵋','帽','幅',
'帮','弼','复','彭','徨','偏','整','第20页 ','下一页','决定' ];
Window_NameInput.LATIN21 =
[
'理','惠','扉','排','斑','酣','普','棉','棒','棚',
'涵','混','淼','淮','淝','牌','画','番','发','皓',
'脉','茗','评','贺','费','买','贸','迫','邯','闵',
...
'提','敬','斟','极','楠','殿','汤','渡','绢','经',
'茎','莒','获','莅','庄','莉','蜀','里','装','解',
'詹','鼎','贾','路','迹','退','铃','第21页 ','下一页','决定' ];
Window_NameInput.LATIN22 =
[
'钜','陀','电','雷','靖','顿','暖','桢','路','嫁',
'农','贮','贷','贴','轸','迪','钠','湍','琳','当',
'略','铃','鼓','励','庸','园','圆','奥','爱','意',
...
'阿','预','饮','衙','莹','蓊','晕','渥','琬','琰',
'畹','筵','裔','淡','催','传','勤','势','嗣','塞',
'嵩','厦','新','喧','楸','楚','岁','第22页 ','下一页','决定' ];
Window_NameInput.LATIN23 =
[
'湘','测','凑','煦','琴','琪','琦','睡','祺','稔',
'稠','筮','粲','绣','群','圣','莎','裙','诩','诗',
'试','诠','详','资','载','送','铅','阻','雌','颂',
...
'烦','琶','琥','盟','睦','碑','禀','聘','腑','荷',
'莫','号','蜂','补','话','酩','附','颁','饭','晕',
'募','焕','廓','愧','沟','管','纲','第23页 ','下一页','决定' ];
Window_NameInput.LATIN24 =
[
'诰','闺','魁','构','歌','恺','斡','荣','构','嘏',
'通','连','这','甄','兢','喜','团','图','奖','嫡',
'对','僚','侥','屡','嶂','崭','彰','廖','熊','溜',
...
'尔','瑜','瑛','瑗','玮','与','舞','苑','诱','语',
'郢','银','摇','榕','荣','温','荥','溶','菸','菀',
'鞅','瑛','僖','逑','速','逍','肾','第24页 ','下一页','决定' ];
Window_NameInput.LATIN25 =
[
'寿','塾','尘','嫩','实','像','侨','岖','慈','滋',
'沧','溶','溪','熊','狮','瑞','瑟','硕','算','粹',
'绸','综','绰','绮','翠','菁','菜','菖','裳','认',
...
'搴','逢','梦','仆','幕','滑','瑚','珲','碧','福',
'绵','翡','腑','萍','华','菩','蜜','裴','豪','宾',
'辅','郝','铭','阀','陌','颇','饮','第25页 ','下一页','决定' ];
Window_NameInput.LATIN26 =
[
'凤','鸣','榜','槐','滏','宽','广','慷','惯','概',
'瑰','葛','葵','课','逵','郭','稿','靠','溉','锆',
'俭','著','价','厉','剧','剑','刘','妖','履','帜',
...
'谅','论','质','驼','践','轮','逮','进','醇','铝',
'阵','震','霆','驾','驻','稽','稻','稷','节','剪',
'几','鲁','黎','侬','涤','墩','幢','第26页 ','下一页','决定' ];
Window_NameInput.LATIN27 =
[
'嶙','锻','褚','亿','仪','影','慰','忧','乐','样',
'欧','毅','演','渔','熬','熠','熨','瑶','缘','纬',
'腰','万','莹','叶','苇','谊','逸','邮','阅','院',
...
'兴','萱','冲','褚','谁','请','贤','赏','赐','趣',
'娴','醉','锐','销','爽','霄','驷','确','磁','穷',
'箭','箱','竖','辍','帜','漩','渐','第27页 ','下一页','决定' ];
Window_NameInput.LATIN28 =
[
'箴','节','绪','翦','葸','诤','谆','质','醇','罚',
'划','哗','坟','墨','币','庙','废','慧','慕','慢',
'暮','樊','标','模','流','浒','汉','满','漫','漂',
...
'窥','糕','膏','盖','钢','龟','购','器','垦','横',
'橄','篙','馆','尽','坛','导','惮','战','撰','整',
'历','瞳','昙','暨','机','橘','洁','第28页 ','下一页','决定' ];
Window_NameInput.LATIN29 =
[
'潭','灯','瑾','璋','庐','积','筑','蒸','诸','谛',
'诺','练','猪','赖','蹄','辑','道','达','都','录',
'锦','锭','陆','陶','陵','霓','霖','静','颊','头',
...
'器','学','宪','熹','憧','晓','桥','樵','橙','橡',
'树','润','潮','甑','莳','璇','聪','融','亲','谌',
'谐','输','遂','醒','钱','错','陈','第29页 ','下一页','决定' ];
Window_NameInput.LATIN30 =
[
'陲','赛','蓄','苍','侪','澍','莼','谊','铮','锡',
'阊','桦','壁','奋','播','抚','横','潘','磨','蒙',
'衡','谋','讳','讽','辨','锚','陪','默','蒲','蓓',
...
'胶','膛','临','举','莲','蔗','蒋','讲','递','辗',
'镀','锻','钟','键','隆','队','骏','黛','点','泽',
'沣','潞','澄','优','婴','屿','狱','第30页 ','下一页','决定' ];
Window_NameInput.LATIN31 =
[
'赢','应','忆','拥','澳','营','蔚','荫','舆','锾',
'闱','阳','偿','择','擅','操','泽','澡','燧','禧',
'穗','簇','纵','总','聪','声','膝','襄','谦','逮',
...
'纩','戴','拟','抬','挤','爵','涛','礼','简','粮',
'职','旧','蕉','谨','转','遮','题','镇','储','藜',
'芷','迟','鲤','翼','芸','讴','医','第31页 ','下一页','决定' ];
Window_NameInput.LATIN32 =
[
'隘','额','瑷','莸','镒','隗','彝','潍','储','丛',
'曙','湿','织','萧','蕊','蝉','适','双','绣','锁',
'垒','戴','断','柠','涛','泞','璐','礼','粮','藜',
...
'镜','觉','际','橹','栎','泺','辚','链','韵','稳',
'薏','薇','膺','臆','蚁','袄','遗','雾','愿','艳',
'蓣','蕹','韫','玺','薛','薪','绳','第32页 ','下一页','决定' ];
Window_NameInput.LATIN33 =
[
'蟹','识','赞','遵','迁','选','庞','渖','荐','谯',
'镟','锵','镞','铲','际','颡','鹑','暹','攀','簿',
'绘','鹏','庞','瀑','宝','祢','薜','谱','镆','镘',
...
'耀','译','议','邀','懿','赢','萨','藏','薰','壤',
'悬','曦','琼','筹','脐','馨','释','献','坏','孀',
'籍','藉','谵','锈','钟','宝','怀','第33页 ','下一页','决定' ];
Window_NameInput.LATIN34 =
[
'瀚','缤','还','迈','飘','膑','朦','濒','铧','顾',
'钚','俪','栏','铁','鸡','镯','藤','览','镭','铎',
'铛','膑','丽','斓','樱','艺','藕','誉','跃','迩',
...
'隐','璎','蕴','鳙','欢','边','鳗','镔','沣','镬',
'矿','恋','兰','体','滩','铄','鳞','驿','验','缨',
'织','显','钻','变','蘩','罐','赣','第34页 ','下一页','决定' ];
Window_NameInput.LATIN35 =
[
'雳','灵','陇','酿','鹰','霭','坝','嬖','观','戆',
'厅','篱','钥','瑷','镶','黉','颢','逻','驴','湾',
'灒','銮','骥','湾','钻','骧','鹦','艳',,' ',' ',
