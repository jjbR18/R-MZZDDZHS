...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    this.drawActorHp(actor, x2 + 100, y + lineHeight * 1, width2);
    this.drawActorMp(actor, x2 + 100, y + lineHeight * 2, width2);
...
Window_SkillStatus.prototype.refresh = function() {
    ...
    if (this._actor) {
        ...
        this.drawActorSimpleStatus(this._actor, xpad, y, width - 400);
    }
};
