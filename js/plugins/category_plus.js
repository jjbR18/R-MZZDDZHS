...
//カテゴリーの追加
    Window_ItemCategory.prototype.makeCommandList = function() {
        ...
        this.addCommand('素材', 'tsuika1');//引数1がメニューでの表示名、引数2がデータ上の分類名
    };
...
//アイテムのカテゴリ分類の判定式
    Window_ItemList.prototype.includes = function(item) {
        ...
        case 'item':
            return DataManager.isItem(item) && item.itypeId === 1 && item.meta.category !== 'mate';
        case 'weapon':
        ...
        case 'tsuika1'://← 上の引数2で指定した名前
            return DataManager.isItem(item) && item.meta.category === 'mate';//この条件を満たしたアイテムが新しいカテゴリに入る
        default:
            return false;
        }
    };
