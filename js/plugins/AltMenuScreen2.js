...
(function() {
    ...
    Window_MenuStatus.prototype.drawItemImage = function(index) {
        ...
        var bitmapName = $dataClasses[actor._classId].meta.stand_picture ;
        if ($gameSwitches.value(18) == true) {var bitmapName = "N" + $dataClasses[actor._classId].meta.stand_picture ;}
        
        var bitmap = bitmapName ? ImageManager.loadEnemy(bitmapName) : null;
        ...
        if($dataClasses[actor._classId].meta.stand_picture_x){
            this.contents.blt(bitmap, sx + ($dataClasses[actor._classId].meta.stand_picture_x * 1) , sy , w, h, dx, dy);
         } else {
            this.contents.blt(bitmap, sx, sy , w, h, dx, dy);
        }
        ///////////////////////////////////////////////////////////////////////////////////////////////////
